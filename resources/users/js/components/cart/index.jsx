    ...
    render (){
        ...
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>Men's Collection - Cart</title>
                    <meta name="description" content="Men Collection" />
                </Helmet>
                {/*SEO Support End */}
                ...
                <section className="cart-section section-b-space">
                    <div className="container">
                                ...
                                <table className="table cart-table table-responsive-xs">
                                    ...
                                    {cartItems.map((item, index) => {
                                        ...
                                        <tbody key={index}>
                                            <tr>
                                                <td>
                                                    <Link to={`/users/product/${item.id}`}>
                                                        <img src={item.variants?
                                                                  item.variants[0].images
                                                                  :item.pictures[0]} alt="" />
                                                    </Link>
                                                </td>
                                                <td><Link to={`/users/product/${item.id}`}>{item.name}</Link>
                        ...
                        <div className="row cart-buttons">
                            <div className="col-6">
                                <Link to={`/users/collection`} className="btn btn-solid">continue shopping</Link>
                            </div>
                            <div className="col-6">
                                <Link to={`/users/checkout`} className="btn btn-solid">check out</Link>
                            </div>
                        </div>
                    </div>
                </section>
